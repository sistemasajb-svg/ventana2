...
$respuestaVenta = ControladorHistorialpagos::ctrMostrarHistorialpagosreporte($itemVenta, $valorVenta);
$respuestaVenta2 = ControladorHistorialpagos::ctrMostrarHistorialpagosreporte2($itemVenta, $valorVenta);
...
$bloque3 = <<<EOF
	...
	<table style="font-size:9px;  padding:2px 1px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:13%; text-align:center">S/PAGO</td>
		<td style="border: 1px solid #666; background-color:white; width:13%; text-align:center">S/A FAVOR</td>
		<td style="border: 1px solid #666; background-color:white; width:39%; text-align:center">DETALLE</td>
		<td style="border: 1px solid #666; background-color:white; width:20%; text-align:center">FECHA</td>
		<td style="border: 1px solid #666; background-color:white; width:15%; text-align:center">CAJA</td>
...
$bloque4 = <<<EOF
	...
	<table style="font-size:9px;  padding:2px 1px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; color:#333; background-color:white; width:13%; text-align:center">
			$item[cantidad]
			</td>
			...
			<td style="border: 1px solid #666; color:#333; background-color:white; width:39%; text-align:center">
			$item[detalle]
			</td>
