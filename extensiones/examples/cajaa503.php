...
EOD;
	...
	<table>
		...
		<tr>
			...
			<td style="font-size:9px; border: 1px solid #666; background-color:white; width:6%; text-align:center; font-weight:bold;">Ingreso</td>
			<td style="font-size:9px; border: 1px solid #666; background-color:white; width:6%; text-align:center; font-weight:bold;">Egreso</td>
			<td style="font-size:9px; border: 1px solid #666; background-color:white; width:22%; text-align:center; font-weight:bold;">Motivo Principal</td>
			<td style="font-size:9px; border: 1px solid #666; background-color:white; width:29%; text-align:center; font-weight:bold;">Detalle</td>
...
EOF;
	...
	<table  >
		...
		<tr>			
			...
			<td style="font-size:7px; border: 1px solid #666; color:#333; background-color:white; width:12%; text-align:center">
			$item[cliente]
			</td>

			<td style="font-size:8px; border: 1px solid #666; color:#333; background-color:white; width:6%; text-align:center">
			$item[ingreso]
			</td>
			...
			<td style="font-size:7px;border: 1px solid #666; color:#333; background-color:white; width:22%; text-align:center">
			$itemdetalleprincipal
			</td>

			<td style="font-size:7px; border: 1px solid #666; color:#333; background-color:white; width:29%; text-align:center">
			$item[detalle]
			</td>
