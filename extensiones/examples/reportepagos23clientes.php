...
$respuestaVenta = ControladorPagos::ctrMostrarHistorialpagosreportee($itemVenta, $valorVenta);
$respuestaVenta2 = ControladorPagos::ctrMostrarHistorialpagosreporte2e($itemVenta, $valorVenta);
