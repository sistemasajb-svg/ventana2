...
$bloque3 = <<<EOF
	...
	<table>
		...
		<tr style="font-size:8px;">
			...
			<td style="border: 1px solid #666; background-color:white; width:11%; text-align:center; font-weight:bold;">Ingreso</td>
			...
			<td style="border: 1px solid #666; background-color:white; width:23%; text-align:center; font-weight:bold;">Detalle</td>
...
<table style="border-collapse: collapse; width: 100%;">
		...
		<tr>
			...
			<td style="font-size:8px; border: 1px solid #666; color:#333; background-color:white; width:11%; text-align:center">
			$item[ingreso]
			</td>
			...
			<td style="font-size:10px; border: 1px solid #666; color:#333; background-color:white; width:23%; text-align:center">
			$item[detalle]
			</td>
