...
$bloque3 = <<<EOF
	...
	<table>
		...
		<tr>
			<td style="border: 1px solid #666; background-color:white; width:7%; text-align:center; font-weight:bold; font-size:11px;">Ticket Nro</td>
			<td style="border: 1px solid #666; background-color:white; width:8%; text-align:center; font-weight:bold; font-size:11px;">Tipo</td>
			<td style="border: 1px solid #666; background-color:white; width:12%; text-align:center; font-weight:bold; font-size:11px;">Cliente</td>
			<td style="border: 1px solid #666; background-color:white; width:12%; text-align:center; font-weight:bold; font-size:11px;">Ingreso</td>
			<td style="border: 1px solid #666; background-color:white; width:10%; text-align:center; font-weight:bold; font-size:11px;">Egreso</td>
			<td style="border: 1px solid #666; background-color:white; width:17%; text-align:center; font-weight:bold; font-size:11px;">Motivo Principal</td>
			<td style="border: 1px solid #666; background-color:white; width:22%; text-align:center; font-weight:bold; font-size:11px;">Detalle</td>
			<td style="border: 1px solid #666; background-color:white; width:12%; text-align:center; font-weight:bold; font-size:11px;"> Encargado & Hora </td>
		</tr>
...
<table style="font-size:11px; border-collapse: collapse; width: 100%;">
		...
		<tr>
			...
			<td style="font-size:9px; border: 1px solid #666; color:#333; background-color:white; width:7%; text-align:center">
			$item[id]
			</td>
			
			
			
			<td style="font-size:9px; border: 1px solid #666; color:#333; background-color:white; width:8%; text-align:center">
			$item[tipo]
			</td>
			...
			<td style="font-size:11px;border: 1px solid #666; color:#333; background-color:white; width:17%; text-align:center">
			$item[detalleprincipal]
			</td>

			<td style="font-size:11px; border: 1px solid #666; color:#333; background-color:white; width:22%; text-align:center">
			$item[detalle]
			</td>
