...
EOD;
	...
	<table>
		...
		<tr>
			...
			<td style="font-size:10px; border: 1px solid #666; background-color:white; width:6%; text-align:center; font-weight:bold;">Egreso</td>
			<td style="font-size:10px; border: 1px solid #666; background-color:white; width:22%; text-align:center; font-weight:bold;">Motivo Principal</td>
...
EOF;
	...
	<table  >
		...
		<tr>			
			...
			<td style="font-size:10px; border: 1px solid #666; color:#333; background-color:white; width:6%; text-align:center">
			$item[salida]
			</td>

			<td style="font-size:9px;border: 1px solid #666; color:#333; background-color:white; width:22%; text-align:center">
